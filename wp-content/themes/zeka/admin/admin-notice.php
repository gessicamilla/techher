...
wp_localize_script(
    ...
    array(
        ...
        'builderStatusData' => array(
            'status'       => zeka_theme()->getPluginsManager()->getPluginState( zeka_get_builder_plugin_slug() ),
            'install_url'  => zeka_theme()->getPluginsManager()->getInstallLink( zeka_get_builder_plugin_slug() ),
            'activate_url' => zeka_theme()->getPluginsManager()->getActivationLink( zeka_get_builder_plugin_slug() ),
            'slug'         => zeka_get_builder_plugin_slug(),
...
<div class="zeka-notice-dont-show-container">
    <button class="button-link zeka-dont-show-notice">
        <?php Translations::escHtmlE( 'dont_show_anymore' ); ?>
    </button>
</div>

<div class="zeka-admin-notice-spacer">
    <div class="zeka-admin-big-notice--container">
        <div class="content-holder">
            <div class="messages-area">
                <div class="title-holder">
                    <h1><?php Translations::escHtmlE( 'would_you_like_to_install_front_page', zeka_theme()->getName() ); ?></h1>
                    <p><?php Translations::escHtmlE( 'theme_description', zeka_theme()->getName() ); ?></p>
                </div>

                <ul>
                    <li>
                        <img src="<?php echo zeka_theme()->getListMarkerUrl()?>" alt="">
            ...
            <div class="front-page-preview">
                <img src="<?php echo esc_url( zeka_theme()->getFrontPagePreview() ); ?>"/>
            </div>
        </div>
    </div>
</div>
